...
6. Validate the site at `https://mcp.arkturian.com` (if applicable) and confirm fresh assets reached `/var/www/mcp.arkturian.com`.

## Rollback Strategy
- Use `.devops/rollback.sh` on the server to restore from `/var/backups/mcp-server-*`.
